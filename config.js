...
global.sudo = process.env.SUDO || '94767330928'
...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'DARK-Hat-MD' : process.env.BOT_NAME,
  ownername: process.env.OWNER_NAME === undefined ? 'Mr.Dinuwa' : process.env.OWNER_NAME,
  sessionName:  process.env.SESSION_ID === undefined ? false : process.env.SESSION_ID,
  author:  process.env.PACK_AUTHER.split(";")[0] === undefined ? 'Mr.Dinuwa' : process.env.PACK_AUTHER.split(";")[0],
  auto_read_status :  process.env.AUTO_READ_STATUS  || 'true' ,
  packname:  process.env.PACK_NAME.split(";")[1] === undefined ? 'DARK-Hat-MD' : process.env.PACK_NAME.split(";")[1],
  autoreaction:  process.env.AUTO_REACTION ||  'true' ,
  antibadword :  process.env.ANTI_BAD_WORD === undefined ? 'fuck,sex,mia,huththa,' : process.env.ANTI_BAD_WORD,
